...
function mostrarAlertaSeguridad(titulo, mensaje) {
  ...
  toast.innerHTML = `
    <div style="display:flex; justify-content:space-between; align-items:center;">
      ...
      <button type="button" onclick="this.closest('#admin-security-toast').remove()" style="background:none; border:none; color:#F4F1EA; display:inline-flex; align-items:center; justify-content:center; cursor:pointer; padding:2px;" aria-label="Cerrar"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
    </div>
